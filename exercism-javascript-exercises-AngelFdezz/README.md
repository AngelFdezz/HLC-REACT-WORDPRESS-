...
Realiza los siguientes retos y entrega los códigos

- [elyses-destructured-enchantments](https://exercism.org/tracks/javascript/exercises/elyses-destructured-enchantments) (rest y spread)
...
export function getSecondCard(deck) {
  const [, secondCard, ...remainingCards] = deck;
...
export function insertFaceCards(deck) {
  const [firstCard, ...remainingCard] = deck;
  return [firstCard, ...FACE_CARDS, ...remainingCard];
}
```

- [elyses-analytic-enchantments](https://exercism.org/tracks/javascript/exercises/elyses-analytic-enchantments) (.indexOf, .some, .every, .some, .find)
...
export function getFirstEvenCardPosition(stack) {
  return stack.findIndex((c) => c % 2);
}
```

- [elyses-enchantments)](https://exercism.org/tracks/javascript/exercises/elyses-enchantments) (.at, .splice, .push, .pop, .unshift, .shift)
